...
<head>
    ...
    <title>Surat Keluar Hari Ini</title>
...
<body>
    ...
    <table class="table-custom">
        <caption>
            <h1>Data Surat Keluar Hari Ini</h1>
        </caption>
        <thead>
            <tr>
                <th>No</th>
        ...
        $query = $conn->query("SELECT * FROM tb_suratkeluar WHERE tanggal = CURDATE() ORDER BY tanggal DESC");
        ...
        if ($jumlah > 0) {
          ...
          <td>
            <a href='hapus_surat_keluar.php?id={$row['id']}' class='btn-hapus' title='Hapus Data'><i class='fas fa-trash-alt'></i></a>          </td>
        </tr>";
                $no++;
            }
        } else {
